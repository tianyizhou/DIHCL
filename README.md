...
### Instructions
- For now, we keep all the DIHCL code in `dihcl.py`. It supports different datasets and models. You can add your own options.
...
- We apply multiple episodes of training epochs. This can be set by epoch numbers: `--epochs 300 --schedule 0 5 10 15 20 30 40 60 90 140 210 300`, for example.
...
- Self-supervised learning might be helfup in some scenarios. Two types of self-supervision regularizations are optional, i.e., `--consistency` and `--contrastive`.
